...
Citizen.CreateThread(function()
	...
	for garage, garageData in pairs(Config.Garages) do
		...
		SetBlipSprite(garageBlip, 524)
		SetBlipDisplay(garageBlip, 4)
		SetBlipScale (garageBlip, 0.75)
		SetBlipColour(garageBlip, 67)
		SetBlipAsShortRange(garageBlip, true)
		BeginTextCommandSetBlipName("STRING")
		AddTextComponentString("Garaj: " .. garage)
				...
				if dstCheck <= 10.0 then
					...
					if draw then
						...
						if dstCheck <= markerSize - 0.1 then
							...
							ESX.ShowHelpNotification(usable and displayText or "Araç seçiniz.")
